...
class PyArrowTableManagerFactory(TableManagerFactory):
    ...
    def create() -> type[TableManager[Any]]:
        ...
        class PyArrowTableManager(TableManager[Union[pa.Table, pa.RecordBatch]]):
            ...
            def to_json(self) -> bytes:
                ...
                return self.data.to_pandas().to_json(orient="records").encode("utf-8")
            ...
            def is_type(value: Any) -> bool:
                ...
                return isinstance(value, pa.Table) or isinstance(value, pa.RecordBatch)

            def get_field_types(self) -> FieldTypes:
                return {
                    column: PyArrowTableManager._get_field_type(self.data[column])
                    for column in self.data.columns
                }

            @staticmethod
            def _get_field_type(column: pa.Array) -> FieldType:
